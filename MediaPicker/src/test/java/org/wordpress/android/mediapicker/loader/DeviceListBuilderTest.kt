...
import org.wordpress.android.mediapicker.source.device.DeviceMediaLoader.DeviceMediaItem
import org.wordpress.android.mediapicker.source.device.DeviceMediaLoader.DeviceMediaList
...
class DeviceListBuilderTest : BaseUnitTest() {
    @Mock lateinit var deviceMediaLoader: org.wordpress.android.mediapicker.source.device.DeviceMediaLoader
    ...
    private lateinit var deviceListBuilder: org.wordpress.android.mediapicker.source.device.DeviceListBuilder
    ...
    private fun setUp(allowedTypes: Set<MediaType>) {
        deviceListBuilder =
            org.wordpress.android.mediapicker.source.device.DeviceListBuilder(
                deviceMediaLoader,
                mediaUtilsWrapper,
                site,
                TEST_DISPATCHER,
