 ...
 */
class MediaPickerEmptyView : LinearLayout {
    ...
    private fun initView(context: Context, attrs: AttributeSet) {
        ...
        layout = View.inflate(context, R.layout.media_picker_empty_view, this)
        ...
        attrs.let {
            val typedArray = context.obtainStyledAttributes(
                it,
                R.styleable.MediaPickerEmptyView,
                0,
                0
            )

            val imageResource = typedArray.getResourceId(
                R.styleable.MediaPickerEmptyView_mpevImage,
                0
            )
            val hideImageInLandscape = typedArray.getBoolean(
                R.styleable.MediaPickerEmptyView_mpevImageHiddenInLandscape,
                false
            )
            val titleAttribute = typedArray.getString(R.styleable.MediaPickerEmptyView_mpevTitle)
            val subtitleAttribute = typedArray.getString(R.styleable.MediaPickerEmptyView_mpevSubtitle)
            val buttonAttribute = typedArray.getString(R.styleable.MediaPickerEmptyView_mpevButton)
